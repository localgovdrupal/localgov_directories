 ...
 */
class DirectoryExtraLocationField {
  ...
  public function entityExtraFieldInfo() {
    ...
    $fields['node']['localgov_directory']['display']['localgov_directory_map'] = [
      ...
      'description' => $this->t("Output from the embedded view map for this channel."),
      'weight' => -20,
      'visible' => TRUE,
    ];
  ...
  protected function getViewEmbed(NodeInterface $node) {
    ...
    if (!$view || !$view->access('node_map_embed')) {
      return;
    }
    return [
      '#type' => 'view',
      '#name' => 'localgov_directory_channel',
      '#display_id' => 'node_map_embed',
      '#arguments' => [$node->id()],
    ];
  }
